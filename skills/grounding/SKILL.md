...
`<page-skill-dir>/reference/lessons_learned.md` (the POSED grounding releases,
...
| owns | `page-grounding` re-runs Process step 2 for revised rows |
...
constrain architecture) and continue to `page-architecture`.

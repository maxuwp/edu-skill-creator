...
| L22 | Controlled scope escalation: declare object, layer, breadth, budget and authority before reviewing; complete the breadth before writing findings; deeper discoveries are scope pressure, graded local delta / controlled descent / major re-scope / relocation, with one descent per round | edu-skill-creator-architecture reviewer boundaries; edu-skill-creator-draft review briefs; edu-skill-creator-test round records; edu-skill-creator-reflect; edu-skill-creator-release; procedure in reference/review_scope_protocol.md | [`lessons/L22_controlled_scope_escalation.md`](lessons/L22_controlled_scope_escalation.md) |
